...
namespace tf2024_asp_razor.Migrations
{
    ...
    [Migration("20250120123659_change-name")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MecanicEntityPlaneTypeEntity", b =>
                {
                    ...
                    b.ToTable("MecanicEntityPlaneTypeEntity");
                });
            ...
            modelBuilder.Entity("tf2024_asp_razor.Models.Entities.Taxable.MecanicEntity", b =>
                {
            ...
            modelBuilder.Entity("MecanicEntityPlaneTypeEntity", b =>
                {
                    ...
                    b.HasOne("tf2024_asp_razor.Models.Entities.Taxable.MecanicEntity", null)
                        .WithMany()
            ...
            modelBuilder.Entity("tf2024_asp_razor.Models.Entities.Taxable.MaintenanceEntity", b =>
                {
                    b.HasOne("tf2024_asp_razor.Models.Entities.Taxable.MecanicEntity", "Checker")
                        .WithMany("Checked")
                    ...
                    b.HasOne("tf2024_asp_razor.Models.Entities.Taxable.MecanicEntity", "Reparer")
                        .WithMany("Repared")
            ...
            modelBuilder.Entity("tf2024_asp_razor.Models.Entities.Taxable.MecanicEntity", b =>
                {
                    b.HasOne("tf2024_asp_razor.Models.Entities.TaxableEntity", null)
                        .WithOne()
                        .HasForeignKey("tf2024_asp_razor.Models.Entities.Taxable.MecanicEntity", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
